# Particle-tracking driver for the LINEAR-ADVECTION baseline.
#
# Identical to run_particle_tracking.jl except:
#   - reads the linear-advection variant of update_state_deterministic!
#     (controlled by which block is uncommented in glacier_model.jl)
#   - writes outputs to run08_linear_advection_run/ (HDF5 to external SSD).
#
# Run: julia --project=test glacier-code/particleda/run_linear_advection.jl
...
mkpath(OUT)
const EXT_OUT = "/Volumes/ZX20/USRA 2026/run08_linear_advection_run"
mkpath(EXT_OUT)
